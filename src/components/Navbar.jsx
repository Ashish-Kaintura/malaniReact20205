...
export default function Navbar() {
  ...
  const navItems = [
    ...
    },
    {
      ...
      dropdown: [
        { label: "Beige", href: "/marble-collection/beige" },
        { label: "Coloured", href: "/marble-collection/coloured" },
        { label: "Onyx", href: "/marble-collection/onyx" },
        { label: "Travertino", href: "/marble-collection/travertino" },
        { label: "Finishes", href: "/marble-collection/finishes" },
        ...
        { label: "White", href: "/marble-collection/white" },
        { label: "Gray", href: "/marble-collection/gray" },
    ...
    },
    {
      ...
      href: "/slimtech-tiles-collections",
      dropdown: [
        { label: "White Tiles", href: "/slimtech-tiles-collections/white-tiles"},
        { label: "Black Tiles", href: "/slimtech-tiles-collections/black-tiles"},
        { label: "Gray Tiles", href: "/slimtech-tiles-collections/gray-tiles" },
      ],
    },
